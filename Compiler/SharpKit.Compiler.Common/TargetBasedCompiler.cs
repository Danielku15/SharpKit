...
namespace SharpKit.Compiler
{
    ...
    public abstract class TargetBasedCompiler : ICompiler
    {
        ...
        private int InternalRun()
        {
            try
            {
                ...
                SkcVersion = typeof(TargetBasedCompiler).Assembly.GetCustomAttribute<AssemblyFileVersionAttribute>().Version;
        ...
        protected abstract ICompilerTarget BuildTarget();
        ...
        {
            return new ManifestHelper { Args = Settings, Log = Log, SkcVersion = SkcVersion, SkcFile = typeof(TargetBasedCompiler).Assembly.Location, ExternalFiles = externalFiles }.CreateManifest();
        }
        ...
        {
            var compilerService = CreateCompilerService();
        ...
        protected abstract CompilerService CreateCompilerService();
