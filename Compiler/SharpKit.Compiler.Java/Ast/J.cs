...
using SharpKit.Compiler.Java.Utils;
using SharpKit.Compiler.Utils;

namespace SharpKit.Compiler.Targets.Java.Ast
{
    static class J
    {
        ...
        public static JNewAnonymousClassExpression CreateActionOrFunc(JBlock body, JParameterDeclaration[] prms, JMemberExpression retType, SkProject project)
        {
            if (prms == null)
        ...
        public static JNewAnonymousClassExpression CreateAction(JBlock body, SkProject project)
        {
            return CreateActionOrFunc(body, null, null, project);
        }
        public static JNewAnonymousClassExpression CreateFunc(JMemberExpression retType, JBlock body, SkProject project)
        {
        ...
        {
            var s = JavaHelper.ToJavaValue(value);
            //if (value is char)
