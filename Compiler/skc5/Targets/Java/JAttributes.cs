...
namespace Mirrored.SharpKit.Java
{
    ...
    public partial class JTypeAttribute : Attribute
    {
        ...
        /// </summary>
        public JMode Mode { get { return _Mode.GetValueOrDefault(); } set { _Mode = value; ApplyJsMode(); } } public JMode? _Mode;
        /// <summary>
        ...
        /// </summary>
        public string GenericArgumentJCode { get { return _GenericArgumentJCode; } set { _GenericArgumentJCode = value; } } public string _GenericArgumentJCode;
        ...
        {
            if (_Mode == JMode.Global)
            {
                GlobalObject = true;
                GoNative();
            }
            else if (_Mode == JMode.Prototype)
            {
                Native = true;
                GoNative();
            }
            else if (_Mode == JMode.Clr)
            {

            }
            else if (_Mode == JMode.ExtJs)
            {
                if (_Native == null)
                    Native = true;
                if (_NativeConstructors == null)
    ...
    #region JMode
    ///<summary>
    ///Specifies the export and interoperability mode of a C# type in Java
    ///</summary>
    public enum JMode
    {
        /// <summary>
    ...
    public partial class JEventAttribute : Attribute
    {
        ///<summary>
    ...
    public partial class JDelegateAttribute : Attribute
    {
        ///<summary>
