...
namespace SharpKit.Java
{
    ...
    static class JNaming
    {
        ...
        static JMemberExpression JName2(this IType ceref, bool omitGenericTypeParameters = false)
        {
            ...
            var name2 = ce.Name;
            var att = ceDef.GetJTypeAttribute();
        ...
        public static JMemberExpression EntityMethodToJFunctionRef(IMethod me)
        {
        ...
        static JMemberExpression JName2(IProperty pe)
        {
            ...
            return J.Member(JCodeImporter.JIdentifier(name));
        }
