...
namespace SharpKit.Compiler.JavaScript.Utils
{
    ...
    public static class SkJs
    {
        ...
        public static JsExpression EntityTypeRefToMember(IType typeRef, bool isGenericArgument)
        {
            ...
            {
                var code = Utils.Sk.GetGenericArugmentJsCode(typeRef.GetEntityType());
                if (code != null)
                    return Js.CodeExpression(code);
            }
            var name = GetEntityJsName(typeRef);
            if (Utils.Sk.IsJsonMode(typeRef.GetEntityType()))
            ...
            if (def != null && Utils.Sk.IsClrType(def))
            {
        ...
        public static JsMemberExpression EntityToMember(IEntity me)
        {
            ...
            {
                var att = Utils.Sk.GetJsMethodAttribute((IMethod)me);
                ...
                var att2 = Utils.Sk.GetJsTypeAttribute(ce);
        ...
        public static JsMemberExpression EntityMethodToJsFunctionRef(IMethod me)
        {
            ...
            else
            {
                ...
                if (!me.IsStatic)
                {
                    if (Utils.Sk.IsNativeType(ownerType))
        ...
        public static string GetEntityJsName(IMethod me2)
        {
            ...
            else
            {
                ...
                if (owner != null && owner is IProperty)
                {
                    ...
                    if (pe.SymbolKind == SymbolKind.Indexer && Utils.Sk.UseNativeIndexer(pe))
                        return "";
            ...
            if (!Utils.Sk.UseNativeOverloads(me))
            {
        ...
        public static string GetEntityJsName(IType ceref)
        {
            ...
            var includeGenericArgs = !Utils.Sk.IgnoreTypeArguments(ceref.GetEntityType());
        ...
        static string GetEntityJsName(this IType ceref, bool shortName)
        {
            ...
            if (ce != null)
                includeGenericArgs = !Utils.Sk.IgnoreTypeArguments(ceref.GetEntityType());
        ...
        static string GetEntityJsNameV2(this IType type, bool shortName)
        {
            ...
            if (shortName)
            {
                ...
                var name = ce.Name;
                if (ce.TypeParameters.IsNotNullOrEmpty() && !Utils.Sk.IgnoreTypeArguments(ce))
        ...
        {
            if (Utils.Sk.ForceMethodSuffix(me))
                return true;
