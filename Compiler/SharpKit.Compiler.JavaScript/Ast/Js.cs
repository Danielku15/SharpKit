...
using CssCompressorExtensions = SharpKit.Compiler.JavaScript.Utils.CssCompressorExtensions;
...
namespace SharpKit.Compiler.JavaScript.Ast
{
    static class Js
    {
        ...
        {
            if (CssCompressorExtensions.IsNullOrEmpty(sts))
                return func;
            if (func.Block == null)
                func.Block = new JsBlock();
            if (func.Block.Statements == null)
        ...
        {
            if (CssCompressorExtensions.IsNullOrEmpty(type))
                type = "Array";
        ...
        {
            if (CssCompressorExtensions.IsNullOrEmpty(name))
                return member;
