...
namespace SharpKit.Compiler.JavaScript.Conversion
{
    class ResolveResultVisitor_Invcation
    {
        ...
        void ProcessPrmBindings()
        {
            ...
            if (Utils.Sk.OmitOptionalParameters(Method))
            {
        ...
        void ProcessMember()
        {
            ...
            MethodAtt = Method != null ? Utils.Sk.GetJsMethodAttribute(Method) : null;
        }

        JsIndexerAccessExpression ProcessIndexer()
        {
            if (Res.Member.SymbolKind == SymbolKind.Indexer && Utils.Sk.UseNativeIndexer((IProperty)Res.Member))
            {
        ...
        {
            if (Method != null && Method.IsExtensionMethod && Res.IsExtensionMethodInvocation && Utils.Sk.ExtensionImplementedInInstance(Method))
            {
        ...
        void ProcessRemoveEmptyPreviousMemberName()
        {
            if (Node2.Member is JsMemberExpression)
            {
                ...
                if (CssCompressorExtensions.IsNullOrEmpty(x.Name) && JsMember.PreviousMember != null)
        ...
        void ProcessGenericMethodArgs()
        {
            ...
            if (Method != null && Method is SpecializedMethod && !Utils.Sk.IgnoreGenericMethodArguments(Method))
            {
        ...
        {
            if (Utils.Sk.IsNativeParams(Method))
            {
        ...
        void TransformIntoBaseMethodCallIfNeeded(CSharpInvocationResolveResult res, JsInvocationExpression node2)
        {
            ...
            if (target != null && target.CausesNonVirtualInvocation) //base.
            {
                ...
                if (ce != null && Utils.Sk.IsExtJsType(ce.GetDefinitionOrArrayType()))
                {
        ...
        public JsNode VisitInvocationResolveResultAsCtor(CSharpInvocationResolveResult res)
        {
            ...
            var meAtt = Utils.Sk.GetJsMethodAttribute(me);
            ...
            {
                var jtfn = ce == null ? null : Utils.Sk.GetJsonTypeFieldName(ce);
        ...
        {
            return Utils.Sk.IsEntityFunctionProperty(me, scope);
        }
